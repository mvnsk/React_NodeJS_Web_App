...
public class HomePageAdapter  extends RecyclerView.Adapter<HomePageAdapter.HomePageView> {
    ...
    public HomePageAdapter(Context context, ArrayList<NewsData> newsArrayList) {
   ...
   /*     String time_woz =originalDateTime.substring(0, originalDateTime.length() - 1);
    ...
    public class HomePageView extends RecyclerView.ViewHolder{
        ...
        public HomePageView(@NonNull View itemView) {
            super(itemView);
            news_title_text_view = (TextView) itemView.findViewById(R.id.titleOfStory_text_view);
            news_image_view = (ImageView) itemView.findViewById(R.id.imageOfStory_image_view);
